...
insert into public.message_templates (id, title, category, situation, base_text, default_tone, compliance_hint)
values
  ('d2000001-0000-0000-0000-000000000001', 'Primer mensaje personalizado', 'prospecting', 'Cuando quieres iniciar una conversacion sin invadir.', 'Saluda por nombre, menciona el contexto del prospecto, ofrece enviar informacion breve y deja libertad para responder.', 'warm', 'No menciones ingresos, bonos ni resultados garantizados.'),
  ('d2000002-0000-0000-0000-000000000002', 'Responder objecion', 'objection', 'Cuando el prospecto dice que no tiene tiempo, dinero o desconfia.', 'Valida la objecion, responde con calma, ofrece informacion oficial y pregunta si desea revisar un recurso corto.', 'calm', 'No presiones ni uses urgencia artificial.'),
  ('d2000003-0000-0000-0000-000000000003', 'Seguimiento amable', 'followup', 'Cuando ya compartiste informacion y toca consultar dudas.', 'Pregunta si pudo revisar la informacion, invita a responder dudas y propone un siguiente paso simple.', 'direct', 'No uses frases como ultima oportunidad o te vas a arrepentir.'),
  ('d2000004-0000-0000-0000-000000000004', 'Reactivar sin incomodar', 'reactivation', 'Cuando una conversacion quedo fria.', 'Retoma con respeto, reconoce que quiza no era el momento y ofrece un resumen actualizado.', 'reactivation', 'Da salida facil: si no desea continuar, esta bien.'),
  ('d2000005-0000-0000-0000-000000000005', 'Primer contacto con un conocido', 'prospecting', 'Quieres abrir conversacion con alguien que ya conoces, sin que se sienta una venta.', 'Saluda con naturalidad como a un conocido, menciona algo personal si aplica y ofrece compartir algo breve que podria interesarle.', 'warm', 'No vendas de golpe; abre conversacion con calidez.'),
  ('d2000006-0000-0000-0000-000000000006', 'Le preocupa el dinero', 'objection', 'El cliente teme que sea una inversion cara o arriesgada.', 'Reconoce su preocupacion por el dinero, aclara que primero puede ver informacion sin comprar nada y ofrece resolver dudas con calma.', 'calm', 'No prometas retorno, ahorro garantizado ni ganancias.'),
  ('d2000007-0000-0000-0000-000000000007', 'Cree que es estafa o piramide', 'objection', 'El cliente desconfia y piensa que es un engano o una piramide.', 'Valida su cautela como algo sano, explica con transparencia que se trata de productos y formacion, y ofrece enviar informacion oficial para que la revise.', 'calm', 'No hables de reclutar ni de comisiones por traer gente.'),
  ('d2000008-0000-0000-0000-000000000008', 'Quedo en pensarlo', 'followup', 'Dijo que lo iba a pensar y no ha respondido.', 'Retoma con respeto y sin presionar, pregunta si pudo revisar la informacion y si tiene alguna duda concreta.', 'warm', 'Evita urgencia o frases de presion.'),
  ('d2000009-0000-0000-0000-000000000009', 'Esta entusiasmado y quiere empezar', 'closing', 'Se mostro muy interesado y quiere dar el siguiente paso.', 'Refleja su entusiasmo con calma, felicita su decision de informarse y propon un siguiente paso simple y claro.', 'direct', 'No prometas resultados; enfocate en el siguiente paso de informacion.'),
  ('d2000010-0000-0000-0000-000000000010', 'Tuvo una mala experiencia antes', 'objection', 'Le fue mal en otro negocio parecido y esta dolido o resentido.', 'Escucha y valida su experiencia pasada, aclara que aqui el enfoque es formacion y productos sin promesas, y ofrece mostrarle como funciona sin compromiso.', 'calm', 'No critiques a terceros ni prometas que aqui si va a ganar.'),
  ('d2000011-0000-0000-0000-000000000011', 'Perdio la motivacion', 'reactivation', 'Un contacto que se desanimo y dejo de avanzar.', 'Acercate con calidez, reconoce que a veces baja el animo y ofrece retomar con un paso pequeno y simple, sin presion.', 'reactivation', 'Premia la constancia, nunca resultados economicos.'),
  ('d2000012-0000-0000-0000-000000000012', 'Felicitar a un cliente por su avance', 'presentation', 'Quieres reconocer el esfuerzo o la constancia de un cliente.', 'Felicita de forma especifica y sincera su constancia, refuerza que lo importante es el habito e invitalo a seguir a su propio ritmo.', 'warm', 'Reconoce actividad y constancia, no ingresos.')
on conflict (id) do nothing;
