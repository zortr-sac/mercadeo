      ...
      sections={[
        {
          ...
          bullets: [
            ...
            "Datos de tu actividad en la plataforma: tu progreso en la academia y el contenido que marcas como favorito (corazón).",
        ...
        },
        {
          ...
          bullets: [
            "Darte acceso a la plataforma, a la academia y a las plantillas de contenido.",
            "Enviarte las notificaciones que tú actives.",
            "Saber qué contenido es más útil (mediante tus reacciones) para mejorar el servicio y darte soporte.",
          ],
        },
        {
